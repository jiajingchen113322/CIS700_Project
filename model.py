...
class GGNN(nn.Module):
    ...
    """
    def __init__(self,state_dim,annotation_dim,n_edge_types,n_node,n_steps):
...
if __name__=='__main__':
    ...
    model=GGNN(state_dim=state_dim,annotation_dim=annotation_dim,n_edge_types=edge_type,n_node=n_node,n_steps=n_step)
    a=1